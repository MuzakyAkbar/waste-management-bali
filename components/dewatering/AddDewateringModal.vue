      ...
      <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
          <div class="sm:flex sm:items-start">
            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
              ...
              <div class="mt-6 space-y-5">
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g. Dewatering Pagi - Batch 1"
                  />
                  <p class="mt-1 text-xs text-gray-500">Nama untuk identifikasi proses dewatering ini</p>
                </div>
              ...
              <div class="mt-4 p-3 bg-cyan-50 border-l-4 border-cyan-400 rounded">
                <div class="flex items-start gap-2">
                  ...
                  <p class="text-xs text-cyan-800">
                    Setelah proses dibuat, isi KWh awal untuk memulai dewatering, lalu tambahkan material input.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
          ...
          >
            ...
            {{ loading ? 'Creating...' : 'Create Dewatering' }}
          </button>
          <button
            type="button"
...
const handleSubmit = async () => {
  ...
  if (!form.value.process_name) {
    return error.value = 'Mohon isi Nama Proses Dewatering.'
  }
  ...
  try {
    ...
    const result = await dewateringStore.createProcess(createData)

    if (!result.success) {
      throw new Error(result.error || 'Gagal membuat proses dewatering')
    }

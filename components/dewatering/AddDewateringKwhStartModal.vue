                ...
                <div class="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      class="block w-full border-gray-300 rounded-lg shadow-sm focus:ring-cyan-500 focus:border-cyan-500 sm:text-sm p-2.5 border"
                    />
                  </div>
                  <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-2">
...
const handleSubmit = async () => {
  ...
  try {
    ...
    const result = await dewateringStore.addKwhStart(props.process.id, kwhData)
